  ...
  <>
    <DivBody className={classes.root}>
      ...
      <ul>
        ...
        <li>Un flux live de comentarii și analize realizate de sociologi din marile centre universitare din România.
        </li>
      </ul>
      <p>
      ...
      <div className={classes.expertWrapper}>
        ...
        <div className={classes.expertDescription}>
          ...
          <p>
            ...
            românilor: 1993-2006. O perspectivă sociologică (volum coordonat alături de Mălina Voicu, Institutul
            European,
            2007), Capital social în România începutului de Mileniu: Drumeţ în ţara celor fără de prieteni? (2010,
            Lumen),
